...
function filterTable() {
    ...
    // Grab input values
    let filterValues = [
    {key:"datetime", value:d3.select("#dateSelect").property("value")},
    {key:"country", value:d3.select("#countrySelect").property("value")},
    {key:"state", value:d3.select("#stateSelect").property("value")},
    {key:"city", value:d3.select("#citySelect").property("value")},
    {key:"shape", value:d3.select("#shapeSelect").property("value")}
    ]
